...
def check_generator(
    generator_cls, service_type: ServiceType, name: str, expected_keywords: dict
):
    ...
    if not resource_tf.strip():
        errors.append("  generate_resource_tf returned empty string")
    if not variables_tf.strip():
        errors.append("  generate_variables_tf returned empty string")
    if not outputs_tf.strip():
        errors.append("  generate_outputs_tf returned empty string")
    ...
    generators = [
        ...
        (
            ...
            "my_kb",
            {
                ...
                "outputs": [
                    "knowledge_base_id",
                    "aws_bedrockagent_knowledge_base.my_kb",
                ],
            },
        ),
        (
