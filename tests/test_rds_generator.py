...
class TestRDSGeneratorWithOptionalConfig:
    ...
    def test_resource_tf_includes_engine(self, gen: RDSGenerator):
        instance = _make_rds_instance(rds_engine="mysql")
        result = gen.generate_resource_tf(instance)
