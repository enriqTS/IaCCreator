    ...
    def generate_variables_tf(self, instance: ResourceInstanceIR) -> str:
        ...
        parts = [
            self._r.render_variable(
                "cluster_id", "string", "ID of the ElastiCache cluster"
            ),
        ]
        if instance.config.elasticache_engine is not None:
            parts.append(
                self._r.render_variable(
                    "engine",
                    "string",
                    "Cache engine for the ElastiCache cluster",
        ...
        if instance.config.elasticache_node_type is not None:
            parts.append(
                self._r.render_variable(
                    "node_type",
                    "string",
                    "Node type for the ElastiCache cluster",
        ...
        if instance.config.elasticache_num_cache_nodes is not None:
            parts.append(
                self._r.render_variable(
                    "num_cache_nodes",
                    "number",
                    "Number of cache nodes in the ElastiCache cluster",
