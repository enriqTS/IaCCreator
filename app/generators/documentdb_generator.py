...
class DocumentDBGenerator:
    ...
    def generate_variables_tf(self, instance: ResourceInstanceIR) -> str:
        ...
        parts = [
            self._r.render_variable("cluster_identifier", "string", "Identifier for the DocumentDB cluster"),
        ]
        if instance.config.documentdb_master_username is not None:
            parts.append(self._r.render_variable(
                "master_username", "string", "Master username for the DocumentDB cluster",
