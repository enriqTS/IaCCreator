"""Lambda → DynamoDB connection handler — grants the Lambda access to the target."""
...
class LambdaDynamoDBHandler(BaseConnectionHandler):
    """Handles Lambda → DynamoDB connections, which only add IAM to the source Lambda."""
    ...
    def handle(
        ...
        statement = IAMStatement(
            ...
            actions=get_actions(
                ...
                connection.connection_config.get("access_pattern", "full"),
            ),
