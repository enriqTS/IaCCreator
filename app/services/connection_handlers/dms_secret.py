...
class DmsSecretEndpointHandler(BaseConnectionHandler):
    ...
    def handle(
        ...
        config = DmsSecretEndpointConfig.model_validate(connection.connection_config)
