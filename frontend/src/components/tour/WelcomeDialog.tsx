/**
 * DEACTIVATED — Dialog-based Welcome Tour
 *
 * This component is intentionally deactivated. It showed a centered modal
 * dialog with screenshots/placeholder images walking through the app areas.
 * It was replaced by OnboardingTour.tsx (lightweight tooltip-based approach)
 * because the screenshot images weren't ready and the dialog felt too heavy.
 *
 * TO REACTIVATE:
 * 1. Uncomment the TOUR_PAGES data in data/tour-pages.ts
 * 2. Update tour-store.ts to use TOUR_PAGES_COUNT (5) and rename currentStep → currentPage
 * 3. Replace the OnboardingTour import in page.tsx with this WelcomeDialog
 * 4. Prepare standardized screenshots at 960×400px in public/tour-images/
 *
 * The component code is preserved below for reference.
 */
