...
The generator registry contains 117 Terraform-capable service types, while the connection registry contains 89 connection specifications involving 45 services.
